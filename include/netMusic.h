...
public:
    ...
    Q_INVOKABLE void collect_audio(QString folderName,QString audioName);
    //取消收藏
    Q_INVOKABLE void dislike_collect_audio(QString folderName,QString audioName);
    //加载收藏列表
    //param:
    //path:所属收藏夹
    ...
    //触发返回信号
    Q_INVOKABLE QList<AsmrItem> get_nameList();
    enum netType
    {
