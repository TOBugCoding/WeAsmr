...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v0.15.3"
  WORKING_DIRECTORY "/mnt/e/QT_projct/WeAsmrPlayer_gay/server/build/_deps/httplib-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/e/QT_projct/WeAsmrPlayer_gay/server/build/_deps/httplib-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/e/QT_projct/WeAsmrPlayer_gay/server/build/_deps/httplib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
